...
class LiquidIngredients:
    ...
    def __init__(self, canvas, ingredientName): # bottleType is the shape of the bottle
        ...
        self.bottleColor = ingredientContainers[ingredientName]["bottleColor"]
        self.isMoving = False
    ...
    def drawBottle(self): 
        ...
        self.bottleLabel = canvas.create_text(centerX, centerY, text = self.ingredientName, font = fontStyle)
